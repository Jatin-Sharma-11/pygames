...
#Game Backgrounds
bg1 = pygame.image.load("Screen/bg.jpeg")
bg2 = pygame.image.load("Screen/bg2.jpeg")
intro = pygame.image.load("Screen/intro1.jpeg")
outro = pygame.image.load("Screen/outro.jpeg")
...
#Game Title
pygame.display.set_caption("Snake game By Jatin Sharma")
...
#GameOverScreen
           ...
           text_screen("Score : " + str(score ), red, 380, 415)
           for event in pygame.event.get():
               if event.type == pygame.QUIT:
                   exit_game = True
               if event.type == pygame.KEYDOWN:
